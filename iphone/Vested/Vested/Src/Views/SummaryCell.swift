...
class SummaryCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        planNameBackground.translatesAutoresizingMaskIntoConstraints = false
        planSummaryBackground.translatesAutoresizingMaskIntoConstraints = false
        ...
        let hPlacement1 = NSLayoutConstraint.constraintsWithVisualFormat("H:|-0-[plan_name_background]-0-|", options: [], metrics: nil, views: viewsDictionary)
        let hplacement2 = NSLayoutConstraint.constraintsWithVisualFormat("H:|-0-[plan_summary_background]-0-|", options: [], metrics: nil, views: viewsDictionary)
        let hplacement3 = NSLayoutConstraint.constraintsWithVisualFormat("H:|-10-[plan_name_label]-24-|", options: [], metrics: nil, views: viewsDictionary)
        let hplacement4 = NSLayoutConstraint.constraintsWithVisualFormat("H:|-0-[vested_label]-0-|", options: [], metrics: nil, views: viewsDictionary)
        let hplacement5 = NSLayoutConstraint.constraintsWithVisualFormat("H:|-0-[vested_amount_label]-0-|", options: [], metrics: nil, views: viewsDictionary)
        let hplacement6 = NSLayoutConstraint.constraintsWithVisualFormat("H:|-0-[unvested_label]-0-|", options: [], metrics: nil, views: viewsDictionary)
        let hplacement7 = NSLayoutConstraint.constraintsWithVisualFormat("H:|-0-[unvested_amount_label]-0-|", options: [], metrics: nil, views: viewsDictionary)
        let hplacement8 = NSLayoutConstraint.constraintsWithVisualFormat("H:|-0-[left_wrapper(==right_wrapper)]-[radial_graph_view]-[right_wrapper(==left_wrapper)]-0-|", options: [], metrics: nil, views: viewsDictionary)
        ...
        let vplacement1 = NSLayoutConstraint.constraintsWithVisualFormat("V:|-8-[plan_name_background]-0-[plan_summary_background]", options: [], metrics: nil, views: viewsDictionary)
        let vplacement2 = NSLayoutConstraint.constraintsWithVisualFormat("V:|-6-[vested_label]", options: [], metrics: nil, views: viewsDictionary)
        let vplacement3 = NSLayoutConstraint.constraintsWithVisualFormat("V:|-6-[unvested_label]", options: [], metrics: nil, views: viewsDictionary)
        let vplacement4 = NSLayoutConstraint.constraintsWithVisualFormat("V:[vested_label]-(-2)-[vested_amount_label]", options: [], metrics: nil, views: viewsDictionary)
        let vplacement5 = NSLayoutConstraint.constraintsWithVisualFormat("V:[unvested_label]-(-2)-[unvested_amount_label]", options: [], metrics: nil, views: viewsDictionary)
        let vplacement6 = NSLayoutConstraint.constraintsWithVisualFormat("V:|-32-[left_wrapper]", options: [], metrics: nil, views: viewsDictionary)
        let vplacement7 = NSLayoutConstraint.constraintsWithVisualFormat("V:|-32-[right_wrapper]", options: [], metrics: nil, views: viewsDictionary)
        let vplacement8 = NSLayoutConstraint.constraintsWithVisualFormat("V:|-10-[plan_name_label]", options: [], metrics: nil, views: viewsDictionary)
        ...
        let vplacement11 = NSLayoutConstraint.constraintsWithVisualFormat("V:|-32-[radial_graph_view]", options: [], metrics: nil, views: viewsDictionary)
